...
globalkeys =
    ...
    awful.key(
        ...
        "d",
        function()
            awful.util.spawn("rofi_launcher.sh")
        end,
        {description = "launch app with rofi", group = "launcher"}
    ),
    -- Lock Screen
    awful.key(
        {modkey},
        ...
        {description = "lockscreen", group = "screen"}
    ),
    awful.key(
        {modkey},
        "Print",
        function()
            awful.spawn.with_shell("sleep 0.5s && screenshot.sh ")
        end,
...
-- awful.spawn.with_shell("polybar.sh")
